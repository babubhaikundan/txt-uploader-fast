...
photologo = 'https://s.tfrbot.com/h/g5lIWO'
photoyt = 'https://s.tfrbot.com/h/sRMf7S'
photocp = 'https://s.tfrbot.com/h/Vf6F3e'
...
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        "<pre><code> 🎉Congrats! You are using 𝕂𝕦𝕟𝕕𝕒𝕟 𝕐𝕒𝕕𝕒𝕧 😎 BOT:</code></pre>\n┣\n"
        "┣⪼01. Send /start - To Check Bot \n┣\n"
        "┣⪼02. Send /kundan - for extract txt file\n┣\n"
...
@bot.on_message(filters.command(["kundan"]) )
async def txt_handler(bot: Client, m: Message):
    ...
    credit = '<a href="https://t.me/kundan_yadav_bot">𝕂𝕦𝕟𝕕𝕒𝕟 𝕐𝕒𝕕𝕒𝕧 😎 </a>'
    if raw_text3 == '1':
        CR = '<a href="https://t.me/kundan_yadav_bot">𝕂𝕦𝕟𝕕𝕒𝕟 𝕐𝕒𝕕𝕒𝕧 😎 </a>'
    elif raw_text3:
        CR = raw_text3
    else:
        CR = credit
    ...
    await m.reply_text(
        f'<pre><a href="https://t.me/kundan_yadav_bot">🎯Target Batch ➤</a> {b_name}</pre>'
    )
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            try:  
                cc = f'**[🎬] 𝗩𝗶𝗱_𝗜𝗱 ➤**{str(count).zfill(3)}**\n**<b>Video Title</b> ➤**{name1}** **[{res}]** **.mp4**\n\n<pre>**Batch Name** ➤ **{b_name}**</pre>\n\n🌟𝐄𝐱𝐭𝐫𝐚𝐜𝐭𝐞𝐝 𝐁𝐲 ➤**{CR}**\n'
                cc1 =  f'**[📁] 𝗣𝗱𝗳_𝗜𝗱 ➤**{str(count).zfill(3)}**\n**<b> Pdf Title</b> ➤**{name1}****.pdf**\n\n<pre>**Batch Name** ➤ **{b_name}**</pre>\n\n🌟𝐄𝐱𝐭𝐫𝐚𝐜𝐭𝐞𝐝 𝐁𝐲 ➤ **{CR}**\n'
                cczip = f'**Zip_ID ➤**[{str(count).zfill(3)}]</a> \n\n<a href="https://t.me/kundan_yadav_bot"><b> Zip Title</b> ➤ **{name1}** **{CR}** **.zip</a>**\n\n<pre>**Batch Name** ➤ **{b_name}**</pre>\n\n𝗘𝘅𝘁𝗿𝗮𝗰𝘁𝗲𝗱 𝗕𝘆 ➤  **{CR}**\n'  
                ...
                if "drive" in url:
                    ...
                    Show = f"🚀𝐏𝐑𝐎𝐆𝐑𝐄𝐒𝐒 » {progress:.2f}%\n┃\n" \
                           ...
                           f'✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ <a href="https://t.me/kundan_yadav_bot">𝕂𝕦𝕟𝕕𝕒𝕟 𝕐𝕒𝕕𝕒𝕧 😎 </a>'
    ...
    await m.reply_text(f'<a href="https://t.me/kundan_yadav_bot">✨𝗕𝗔𝗧𝗖𝗛 𝗦𝗨𝗠𝗠𝗔𝗥𝗬✨\n\n'
                       f'▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n'
    ...
    await m.reply_text('📥𝗘𝘅𝘁𝗿𝗮𝗰𝘁𝗲𝗱 𝗕𝘆 ➤ <a href="https://t.me/kundan_yadav_bot">𝕂𝕦𝕟𝕕𝕒𝕟 𝕐𝕒𝕕𝕒𝕧 😎 </a><a href="https://t.me/kundan_yadav_bot">𝕂𝕦𝕟𝕕𝕒𝕟 𝕐𝕒𝕕𝕒𝕧 ⚠️ </a>')
        ...
        for i in range(arg-1, len(links)):
            ...
            try:  
                ...
                if ".pdf" in url or "drive" in url:
                    ...
                    Show = f"<pre><code>⚡Dᴏᴡɴʟᴏᴀᴅ Sᴛᴀʀᴛᴇᴅ...⏳\n✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ <b> @kundan_yadav_bot </b></code></pre>"
                    prog = await m.reply_text(Show, disable_web_page_preview=True)
                    res_file = await helper.download_video(url, cmd, name)
                    filename = res_file
                    await prog.delete(True)
                ...
                await m.reply_text(f'——— ✨ [{str(count).zfill(3)}]({link0}) ✨ ———\nYou can manually Check.\n\n📔𝐓𝐢𝐭𝐥𝐞 » `{name}`\n🔗𝐋𝐢𝐧𝐤 » <a href="{link0}">__**Click Here to See Link**__</a>\n\n✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ <b>𝕂𝕦𝕟𝕕𝕒𝕟 𝕐𝕒𝕕𝕒𝕧 ⚠️ </b>')
                count += 1
                continue

    except Exception as e:
        await m.reply_text(e)
    await m.reply_text("<pre><code>Converted By ⌈✨『<b> 𝕂𝕦𝕟𝕕𝕒𝕟 𝕐𝕒𝕕𝕒𝕧 ⚠️ </b>』✨⌋</code></pre>")
    ...
    try:
        ...
        # Check if the response status is OK
            ...
            # Remove the PDF file after sending
                    ...
                    emoji_message = await show_random_emojis(message)
                    Show = f"<pre><code>**⚡Dᴏᴡɴʟᴏᴀᴅ Sᴛᴀʀᴛᴇᴅ...⏳**</code></pre>\n🔗𝐋𝐢𝐧𝐤 » `{link}`\n<pre><code>✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ `𝕂𝕦𝕟𝕕𝕒𝕟 𝕐𝕒𝕕𝕒𝕧 😎`</code></pre>"
